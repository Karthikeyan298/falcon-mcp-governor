...
import { ParamRuleBuilderComponent } from '../shared/param-rule-builder.component';
import { ToolPolicyMatrixComponent } from '../shared/tool-policy-matrix.component';

@Component({
  selector: 'app-policies',
  imports: [PolicyRuleBuilderComponent, ParamRuleBuilderComponent, PolicyCodeComponent, ToolPolicyMatrixComponent],
